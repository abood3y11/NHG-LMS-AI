  ...
  return (
    <div className="p-8">
        ...
        {stats.map((stat, index) => (
          <div key={index} className="bg-white rounded-2xl p-6 shadow-sm">
            <div className="flex items-center justify-between">
              ...
              <div className={`${index === 2 ? 'text-blue-500' : 'text-indigo-600'}`}>
      ...
      <div className="grid grid-cols-3 gap-8">
        <div className="col-span-2">
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            <div className="flex gap-4 mb-6">
              <button className="px-4 py-2 text-sm text-gray-600 hover:text-gray-900">Total Student</button>
              <button className="px-4 py-2 text-sm text-gray-600 hover:text-gray-900">Total Courses</button>
              <button className="px-4 py-2 text-sm text-gray-600 hover:text-gray-900">Status</button>
            </div>
                ...
                <div className="relative w-48 h-48">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      <p className="text-3xl font-bold">35.4%</p>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm">
          <div className="mb-8">
            <button className="w-full bg-blue-600 text-white rounded-lg py-3 px-4 flex items-center justify-center">
              Display your Schedule
              <ChevronRight className="h-5 w-5 ml-2" />
            </button>
            <button className="w-full mt-4 border border-gray-200 rounded-lg py-3 px-4 text-gray-600 flex items-center justify-center">
